...
import com.spring.hibernate.exceptions.BookStockException;
import com.spring.hibernate.exceptions.UserAccountException;
...
public class BookShopDaoImpl implements BookShopDao{
	...
	//不推荐使用HibernateTemplate和HibernateDaoSupport，因为这样会导致Dao和Spring的API耦合，可移植性变差
