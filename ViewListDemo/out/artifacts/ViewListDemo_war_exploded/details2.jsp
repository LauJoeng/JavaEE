      ...
      <table width="750" height="60" cellpadding="0" cellspacing="0" border="0">
        <tr>
          ...
          <td width="70%" valign="top">
             ...
             <div id="cart">
               <img src="images2/buy_now.png"><a href="javascript:selflog_show(<%=item.getId()%>)"><img src="images2/in_cart.png"></a><a href="servlet/CartServlet?action=show"><img src="images2/view_cart.jpg"/></a>
             </div>
          </td>
          <% 
            }
